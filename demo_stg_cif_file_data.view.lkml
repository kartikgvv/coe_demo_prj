view: demo_stg_cif_file_data {
sql_table_name: STG_CIF_FILE_DATA ;;
...
dimension: usps_zip4_types {
type: string
sql: ${TABLE}.usps_zip4_types ;;
}
...
dimension: fips_numeric_state_code {
type: number
sql: ${TABLE}.fips_numeric_state_code ;;
}
...
dimension: latlong_match_level {
type: number
sql: ${TABLE}.latlong_match_level ;;
}
...
dimension: e1_segment_match_flag {
type: number
sql: ${TABLE}.e1_segment_match_flag ;;
}
...
dimension: children_presence_of_child_0_18 {
type: string
sql: ${TABLE}.children_presence_of_child_0_18 ;;
}
...
dimension: homeowner_combined_homeownerrenter {
type: string
sql: ${TABLE}.homeowner_combined_homeownerrenter ;;
}
...
dimension: propertyrealty_home_year_built {
type: string
sql: ${TABLE}.propertyrealty_home_year_built ;;
}


dimension: estimated_current_home_value {
type: string
sql: ${TABLE}.estimated_current_home_value ;;
}
...
dimension: auto_in_the_market_used_11_vehicle {
type: string
sql: ${TABLE}.auto_in_the_market_used_11_vehicle ;;
}
...
dimension: craftshobby_merchandise_buyer {
type: number
sql: ${TABLE}.craftshobby_merchandise_buyer ;;
}


dimension: gardeningfarming_buyer {
type: number
sql: ${TABLE}.gardeningfarming_buyer ;;
}
...
dimension: gifts_and_gadgets_buyer {
type: number
sql: ${TABLE}.gifts_and_gadgets_buyer ;;
}


dimension: general_merchandise_buyer {
type: number
sql: ${TABLE}.general_merchandise_buyer ;;
}
...
dimension: health_institution_contributor {
type: number
sql: ${TABLE}.health_institution_contributor ;;
}
