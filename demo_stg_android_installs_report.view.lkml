view: demo_stg_android_installs_report {
sql_table_name: STG_ANDROID_INSTALLS_REPORT ;;
...
dimension_group: contributor_1_touch_time {
type: time
timeframes: [raw,time,date,week,month,quarter,year]
...
dimension_group: contributor_2_touch_time {
type: time
timeframes: [raw,time,date,week,month,quarter,year]
...
dimension_group: contributor_3_touch_time {
type: time
timeframes: [raw,time,date,week,month,quarter,year]
...
dimension_group: google_play_click_time {
type: time
timeframes: [raw,time,date,week,month,quarter,year]
...
dimension_group: google_play_install_begin_time {
type: time
timeframes: [raw,time,date,week,month,quarter,year]
